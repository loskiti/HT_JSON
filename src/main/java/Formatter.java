...
public class GetJSONFormat implements Server {
    ...
    public GetJSONFormat(@NotNull HttpServer myServer, @NotNull Gson Jbuilder) {
    ...
    /**
     * Starting myServer and waiting for a Json files
     *
     * @param args - does not matter
     * @throws IOException - because constructor of GetJSONFormat can throw IOException
     */
    ...
    /**
     * Implements method of bind myServer to HTTP port and start listening.
     */
    @Override
    public void start() {
        this.myServer.start();
